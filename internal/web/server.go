...
func (s *Server) routes() http.Handler {
	...
	mux.Handle("PUT /api/groups", s.requireAuth(http.HandlerFunc(s.handleRenameGroup)))
	mux.Handle("PUT /api/keywords", s.requireAuth(http.HandlerFunc(s.handleRenameKeyword)))
	mux.Handle("GET /api/keyword-colors", s.requireAuth(http.HandlerFunc(s.handleGetKeywordColors)))
	mux.Handle("PUT /api/keyword-colors", s.requireAuth(http.HandlerFunc(s.handleSetKeywordColor)))
